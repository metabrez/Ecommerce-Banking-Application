...
public class AccountServiceImpl implements AccountService {
	...
	public void deposit(String accountType, double amount, Principal principal) {
		...
		if (accountType.equalsIgnoreCase("Primary")) {
			...
			savingsAccountDao.save(savingsAccount);
			Date date = new Date();
			SavingsTransaction savingsTransaction = new SavingsTransaction(date, "Deposit to Savigns Account",
	...
	public void withdraw(String accountType, double amount, Principal principal) {
		...
		if (accountType.equalsIgnoreCase("Primary")) {
			...
			savingsAccountDao.save(savingsAccount);
			Date date = new Date();
			SavingsTransaction savingsTransaction = new SavingsTransaction(date, "Withdraw from Savigns Account",
					"Account", "Finished", amount, savingsAccount.getAccountBalance(), savingsAccount);
